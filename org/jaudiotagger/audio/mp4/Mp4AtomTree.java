...
public class Mp4AtomTree
{
    ...
    {
        buildTree(raf.getChannel(), closeOnExit);
    }

    public Mp4AtomTree(FileChannel fc, boolean closeOnExit) throws IOException, CannotReadException
    {
