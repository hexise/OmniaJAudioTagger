...
public class OggPageHeader {
     ...
     * @throws CannotReadException
     */
    public static OggPageHeader read(ChannelRandomAccessAdapter raf) throws IOException, CannotReadException {
        long start = raf.getFilePointer();
        logger.fine("Trying to read OggPage at: " + start);
        ...
        b = raf.read(OggPageHeader.OGG_PAGE_HEADER_FIXED_LENGTH + pageSegments);
