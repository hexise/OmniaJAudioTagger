 ...
 */
class RealFileReader extends AudioFileReader
{
    ...
    private RealChunk findPropChunk(FileChannel raf) throws IOException, CannotReadException
    {
    ...
    private RealChunk findContChunk(FileChannel raf) throws IOException, CannotReadException
    {
        final RealChunk rmf = RealChunk.readChunk(raf);
        final RealChunk prop = RealChunk.readChunk(raf);
