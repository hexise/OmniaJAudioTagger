...
class AudioFile
{
     ...
     */
    protected IFileEntry file;

    /**
     * The Audio header info
     */
    protected org.jaudiotagger.audio.AudioHeader audioHeader;
     ...
     */
    public AudioFile(IFileEntry f, org.jaudiotagger.audio.AudioHeader audioHeader, Tag tag)
    {
        this.file = f;
     ...
     * @param file
     */
    public void setFile(IFileEntry file)
    {
        this.file = file;
    }
     ...
     * @return
     */
    protected ChannelProvider checkFilePermissions(IFileEntry file) throws FileNotFoundException, CannotReadException
    {
        ...
        return new ChannelProvider(file);
    }
