 ...
 */
class AsfHeaderReader extends ChunkContainerReader<AsfHeader>
{
    /**
    ...
    {
        return new FullRequestInputStream(new BufferedInputStream(Channels.newInputStream(raf)));
    }
     ...
     */
    public static AsfHeader readHeader(final FileChannel file) throws IOException
    {
