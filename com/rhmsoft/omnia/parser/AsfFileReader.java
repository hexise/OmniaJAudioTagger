 ...
 */
class AsfFileReader extends AudioFileReader
{
     ...
     */
    @Override
    public AudioFile read(final IFileEntry f) throws CannotReadException, IOException, TagException, ReadOnlyFileException, InvalidAudioFrameException
    {
        if (!f.canRead())
        {
        ...
        try
        {
            stream = new FullRequestInputStream(new BufferedInputStream(f.openInputStream()));
