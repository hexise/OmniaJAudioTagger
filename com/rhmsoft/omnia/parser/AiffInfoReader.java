 ...
 */
class AiffInfoReader extends AiffChunkReader {
    public static Logger logger = Logger.getLogger("org.jaudiotagger.audio.aiff");


    protected GenericAudioHeader read(IFileEntry file) throws CannotReadException, IOException {
        FileInputStream raf = null;
        try {
            raf = file.openInputStream();
