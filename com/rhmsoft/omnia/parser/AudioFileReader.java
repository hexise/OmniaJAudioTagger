...
abstract class AudioFileReader
{
    ...
    *
    * @param raf The FileChannel associtaed with the current file
    ...
    */
    ...
    /*
      ...
      *
      * @param raf The FileChannel associted with the current file
      * @exception IOException is thrown when the RandomAccessFile operations throw it (you should never throw them manually)
    ...
    public AudioFile read(IFileEntry f) throws CannotReadException, IOException, TagException, ReadOnlyFileException, InvalidAudioFrameException
    {
        ...
        ChannelProvider raf = null;
        try
        {
            raf = new ChannelProvider(f);
