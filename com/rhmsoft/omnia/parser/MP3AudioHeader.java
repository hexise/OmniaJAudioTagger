 ...
 */
class MP3AudioHeader implements AudioHeader
{
     ...
     */
    public MP3AudioHeader(final IFileEntry seekFile) throws IOException, InvalidAudioFrameException
    {
        if (!seek(seekFile, 0))
        {
     ...
     * @throws InvalidAudioFrameException
     */
    public MP3AudioHeader(final IFileEntry seekFile, long startByte) throws IOException, InvalidAudioFrameException
    {
     ...
     */
    public boolean seek(final IFileEntry seekFile, long startByte) throws IOException
    {
        ...
        final FileInputStream fis = seekFile.openInputStream();
     ...
     * @throws IOException
     */
    private boolean isNextFrameValid(IFileEntry seekFile, long filePointerCount, ByteBuffer bb, FileChannel fc) throws IOException
    {
        if (MP3AudioHeader.logger.isLoggable(Level.FINEST))
        {
