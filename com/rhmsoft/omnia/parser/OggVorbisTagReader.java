...
class OggVorbisTagReader {
    ...
    public byte[] readRawPacketData(FileChannel channel) throws CannotReadException, IOException {
        ...
        byte[] b = raf.read(VorbisHeader.FIELD_PACKET_TYPE_LENGTH + VorbisHeader.FIELD_CAPTURE_PATTERN_LENGTH);
     ...
     * @throws IOException
     */
    protected byte[] convertToVorbisCommentPacket(OggPageHeader startVorbisCommentPage, ChannelRandomAccessAdapter raf) throws IOException, CannotReadException {
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        byte[] b = raf.read(startVorbisCommentPage.getPacketList().get(0).getLength() - (VorbisHeader.FIELD_PACKET_TYPE_LENGTH + VorbisHeader.FIELD_CAPTURE_PATTERN_LENGTH));
        baos.write(b);
        ...
        while (true) {
            ...
            b = raf.read(currentHeader.getPacketList().get(0).getLength());
            baos.write(b);
